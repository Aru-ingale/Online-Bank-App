...
<body>
	...
	<div>
		<FORM style="float: left;" NAME="CarLoanPage"
			ACTION="CarLoanServlet.do" METHOD="POST" onsubmit="return validation()">
			<TABLE cellPadding='3' ALIGN='center'>
				<tr class="form-group">
					<td>FULL NAME:</td>
					<td><input type="text" name="fullname" id="fullname" class="form-control" Value='' SIZE="15"
				...
				<tr class="form-group">
					<td>DATE OF BIRTH:</td>
					<td><INPUT type="date" name='dob' id="dob" class="form-control" Value='' SIZE='15'
